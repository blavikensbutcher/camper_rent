  ...
  return (
    <ul className={css.tags_container}>
      ...
      {data.details.kitchen === 1 && (
        <TagItem>
          <SharedSVG svgId={"kitchen"} className={css.svg_two} />
          {data.details.kitchen} Kitchen
        </TagItem>
      )}
      <TagItem>
        <SharedSVG svgId={"bed"} className={css.svg_two} />
      ...
      {data.details.freezer >= 1 && (
        <TagItem>
          <SharedSVG svgId={"freezer"} className={css.svg_two} />
          {data.details.kitchen} Freezer
        </TagItem>
      )}
      {data.details.gas && (
        <TagItem>
